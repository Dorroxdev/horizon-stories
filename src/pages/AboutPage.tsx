    ...
    <div>
      ...
      <section className="hero-mesh py-24">
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl text-center">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary/30 to-nessie/20 flex items-center justify-center text-3xl font-bold text-foreground/70 mx-auto mb-6">AD</div>
