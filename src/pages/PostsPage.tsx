...
export default function PostsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Posts. Horizon Launchpad</title>
        <meta
          name="description"
          content="Founder stories, expert playbooks, AI strategy, post-mortems, and frameworks. Written for builders."
        />
        <meta property="og:title" content="Posts. Horizon Launchpad" />
        <meta
          property="og:description"
          content="Founder stories, expert playbooks, AI strategy, post-mortems, and frameworks. Written for builders."
        />
        <meta property="og:image" content="https://horizonlaunchpad.com/og-image.png" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <link rel="canonical" href="https://horizonlaunchpad.com/posts" />
      </Helmet>
